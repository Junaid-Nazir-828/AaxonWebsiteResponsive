...
export default function Techs() {
    return (
        <section className="bg-techBg w-full bg-no-repeat">
                ...
                <div className="flex lg:flex-row flex-col lg:gap-x-8 gap-y-8 my-16 mx-20">
                    <div className="border-2 text-center shadow-[5px_5px_16px_0px_#0000001A] rounded-[20px] bg-white">
                        ...
                        <div className="font-normal sm:text-[16px] text-[14px] leading-[19px] tracking-[0.02em] mt-4 px-4 pb-10">
                            ...
                            insights to drive informed decision-making to help
                    ...
                    <div className="border-2 text-center shadow-[5px_5px_16px_0px_#0000001A] rounded-[20px] bg-white">
                        ...
                        <div className="font-normal sm:text-[16px] text-[14px] leading-[19px] tracking-[0.02em] mt-4 px-4 pb-10">
                            ...
                            practices to design and develop responsive,
                    ...
                    <div className="border-2 text-center shadow-[5px_5px_16px_0px_#0000001A] rounded-[20px] bg-white">
                        ...
                        <div className="font-normal sm:text-[16px] text-[14px] leading-[19px] tracking-[0.02em] mt-4 px-4 pb-10">
                            ...
                            integrate core business functions and enable
