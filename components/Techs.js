...
export default function Techs() {
    return (
        <section className="overflow-hidden">
            ...
            <div className="lg:h-[97vh] h-[180vh] border-2">
                <div className="absolute">
                    ...
                    <div className="flex lg:flex-row flex-col lg:gap-x-8 gap-y-8 mt-16 mx-20">
                        <div className="border-2 text-center shadow-[5px_5px_16px_0px_#0000001A] rounded-[20px] bg-white">
                            ...
                            <div className="font-semibold text-2xl  leading-[28px] tracking-[0.02em] mt-4">
                                Data <br></br>Analytics
                            </div>
                            <div className="font-normal text-[16px] leading-[19px] tracking-[0.02em] mt-4 px-4 pb-10">
